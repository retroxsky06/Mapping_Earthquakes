...
// Create the map object with a center of Toronto. and zoom level.
let map = L.map('mapid', {
    center: [44.0, -80.0],
    zoom: 2,
    layers: [light]
...
let torontoData = "https://raw.githubusercontent.com/retroxsky06/Mapping_Earthquakes/main/torontoRoutes.json";
